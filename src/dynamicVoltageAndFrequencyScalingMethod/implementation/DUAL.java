...
/**
 * Dual Speed implementation of Dynamic Voltage and Frequency Scaling Method.
 * @author ShiuJia
 */
public class DUAL extends DynamicVoltageAndFrequencyScalingMethod
{
    ...
    /**
     * Inner class for remote blocking information.
     */
    public class RemoteBlocking
    {
        ...
        /**
         * Constructor for RemoteBlocking.
         */
        public RemoteBlocking() {
        }
    }
