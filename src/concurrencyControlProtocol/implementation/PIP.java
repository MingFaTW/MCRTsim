...
/**
 * Helper class for managing suspension queues for shared resources.
 * 
 * @author ShiuJia
 */
 ...
 * <p>
 * PIP is a concurrency control protocol where a job holding a resource
 * temporarily inherits the priority of any higher-priority job blocked
 * on that resource, preventing priority inversion.
 * 
 * @author ShiuJia
 */
...
{   
    ...
    /**
     * Constructs a new PIP protocol instance.
     */
    public PIP()
    {
